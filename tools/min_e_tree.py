...
#
# min_e_tree.py packages configurations, entropies, and energies of all states
# of the protein into .dat and .mtx files for creating tree diagrams from min_e
# data
#
# example of how to run:
# python ../tools/min_e_tree.py min_e.csv crambin_min_e
...
def main(args):
    ...
    with open(args.csv, 'r') as input_csv:
        e_data = csv.reader(input_csv, delimiter=',')

        next(e_data)
        for row in e_data:
            state.append(float(row[0]))
...
if __name__ == '__main__':
    ...
    parser.add_argument('csv', help='min_e csv file')
